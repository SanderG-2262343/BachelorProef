...
STORAGE_DIR = "data_projects_2024_5_vector_store_VoyageAI_Title"
CURRENT_DATASET = "data_projects_2024_5_participants.csv"

if os.path.exists("data/vectorStores/" + STORAGE_DIR): #If data not already processed
...
for i in range(0,len(project_data['cfAbstr']),batch_size):
    ...
    vector_store.add_texts(texts=titles[i:i+batch_size], ids=project_data['cfProjId'][i:i+batch_size])
